...
import com.a5universe.chatapp.ui.group.groupActivity.GroupInfoActivity
import com.squareup.picasso.Picasso

class UpdateAddMemberAdapter (
    private val groupInfoActivity: GroupInfoActivity,
...
): RecyclerView.Adapter<UpdateAddMemberAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): UpdateAddMemberAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_user_find_friends, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: UpdateAddMemberAdapter.ViewHolder, position: Int) {
